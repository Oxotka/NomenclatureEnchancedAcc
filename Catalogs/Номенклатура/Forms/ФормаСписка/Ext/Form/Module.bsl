...
&НаКлиенте
Процедура ПИН_ДокументПеремещениеТоваровПеред(Команда)
	СоздатьДокумент("ПеремещениеТоваров");
КонецПроцедуры

&НаКлиенте
Процедура ПИН_ДокументТребованиеНакладнаяПосле(Команда)
	СоздатьДокумент("ТребованиеНакладная");
КонецПроцедуры

&НаКлиенте
Процедура ПИН_ДокументСписаниеТоваровПеред(Команда)
	СоздатьДокумент("СписаниеТоваров");
КонецПроцедуры
...
Процедура ДобавитьСтрокуВКорзину(ВыделеннаяСтрока)
	...
	СтруктураВыбора.Номенклатура = Элементы.Список.ТекущаяСтрока;
